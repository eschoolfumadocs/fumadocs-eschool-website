...
description: Kelola informasi gaji dan tunjangan guru
icon: DollarSign
---
...
4. Pilih opsi **Informasi Gaji**.
5. Sistem akan menampilkan form seperti pada gambar di atas.
...
- **Jenis Pengurangan**: Misalnya Pajak, Potongan Absensi, atau pengurangan berdasarkan periode.
- **Persentase**: Persen pengurangan dari gaji pokok atau total.
- Gunakan tombol **+ Pengurangan Baru** untuk menambahkan entri lain.
...
| Komponen | Keterangan |
|----------|------------|
| **Gaji Pokok** | Gaji utama yang diterima guru. |
| **Tunjangan** | Total seluruh tambahan gaji. |
...
- **Gaji Bersih** = 55 + 20.000 - 5.5 = **20.049,5**
...
- Klik **Simpan** setelah selesai menginput atau memperbarui data.
