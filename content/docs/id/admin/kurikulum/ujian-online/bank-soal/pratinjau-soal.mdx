...
- **Teks Soal**: Ditampilkan lengkap sebagaimana akan dilihat siswa.
- **Catatan (jika ada)**: Misalnya "Ini numerik" sebagai petunjuk internal.
- **Kolom Jawaban**: Tempat simulasi siswa mengisi jawaban.
- **Tombol**:
  - **Reset**: Menghapus isian di kolom jawaban.
